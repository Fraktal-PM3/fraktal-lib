 ...
 */
export type PackageDetailsWithId = PackageDetails & {
    id: string;
};
/**
 ...
 */
export type PackageEventHandler = (res: BlockchainEventDelivery | FireFlyDatatypeMessage) => void;
/**
 ...
 */
export declare function isPackageDetailsMessage(msg: FireFlyDatatypeMessage): msg is FireFlyDatatypeMessage & {
 ...
 */
export declare function isTransferOfferMessage(msg: FireFlyDatatypeMessage): msg is FireFlyDatatypeMessage & {
